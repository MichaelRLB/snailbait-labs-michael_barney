var SnailBait = function () {
   ...
   this.jumpBehavior = {
      ...
      isDescending: function (sprite) {
         //slow down works, but can't get it to speed up again.
         //snailBait.setTimeRate(0.3);         
      ...
      finishDescent: function (sprite, now) {
         //second setTimeRate isn't working.
         sprite.stopJumping();
...
SnailBait.prototype = {
   ...
   equipRunnerForFalling: function () {
      ...
      this.runner.stopFalling = function () {
         ...
         //For some reason, the speed up only works when the runner touches the bottom platform.
         console.log("Speed up trigger test")
         snailBait.setTimeRate(1.0);
      };
   },
