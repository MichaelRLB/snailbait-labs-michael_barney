...
SnailBait.prototype = {
   ...
   */
   ...
   turnLeft: function () {
      ...
      //Are we supposed to have animation here?
      this.runner.artist.cells = this.scruffyCellsLeft;
   },

   turnRight: function () {
      this.bgVelocity = this.BACKGROUND_VELOCITY;
      //Are we suppossed to have animation here?
      //Change to turnRight cells aren't working.
...
window.onkeydown = function (e) {
   ...
   if (key === 68 || key === 37) { // 'd' or left arrow
      //turnRight is triggering instead of turnLeft when using "d" key for some reason.
      snailBait.turnLeft();
   }
